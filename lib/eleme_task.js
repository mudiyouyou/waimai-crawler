...
class ElemeTask extends FetchTask {
    ...
    fetchPage(pageNum) {
        ...
        let getOrdersParam = {
            ...
            "params": {
                ...
                "orderFilter":"ORDER_QUERY_ALL",
                "condition": {
                    "beginTime": this.option.beginTime.format('YYYY-MM-DDTHH:mm:ss.SSS'),
                    "endTime": this.option.endTime.format('YYYY-MM-DDTHH:mm:ss.SSS'),
    ...
    convertToReport(orders) {
        _.each(orders, (order)=> {
            ...
            order.order_create_time = order.activeTime;
