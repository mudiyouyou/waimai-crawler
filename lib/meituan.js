...
function convertToReport(orders) {
    _.each(orders, (order)=> {
        ...
        order.distance = geolib.getDistance({latitude:order.address_latitude/1000000,longitude:order.address_longitude/1000000},{latitude:order.poi_latitude/1000000,longitude:order.poi_longitude/1000000});
    });
